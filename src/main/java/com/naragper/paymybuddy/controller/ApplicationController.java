...
import com.naragper.paymybuddy.model.Role;
...
public class ApplicationController {
	...
	public String signup(@ModelAttribute("signupForm") SignupForm signupForm, Model model) {
		...
		if (signupForm.getUsername() != null) user.setUsername(signupForm.getUsername());
		if (signupForm.getFirstName() != null) user.setFirstName(signupForm.getFirstName());
		if (signupForm.getLastName() != null) user.setLastName(signupForm.getLastName());
